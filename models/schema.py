...
class AgentSchema(BaseModel):
    ...
    is_safe_sql_response: str = Field(default="", description="Safety judgment returned by the SQL judge")
...
class JudgeSchema(BaseModel):
    ...
    comments: str = Field(..., description="Additional comments regarding the safety of the generated SQL query")